// constants
export var ZOOM_CONSTANT = 15; // increase or decrease value for zoom on mouse wheel

export var MOUSE_WHEEL_COUNT = 5; // A mouse delta after which it should stop preventing default behaviour of mouse wheel

export function noop() {} // ease out method
...
export function wrap(element, _ref) {
